...
public class ViewerLayout extends ImageLayout implements LayoutManager2 {

	protected int hgap;
	protected int vgap;
	protected ViewerCanvas ic5d;
	...
	public ViewerLayout(ViewerCanvas ic5d) {
		super(ic5d);
		this.ic5d = ic5d;
		this.hgap = 4;
		this.vgap = 4;
	...
	public void addLayoutComponent(String name, Component comp) {
		synchronized (comp.getTreeLock()) {
			if (CANVAS.equals(name)) {
				if (comp instanceof ViewerCanvas) {

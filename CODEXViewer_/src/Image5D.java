...
//			}
    ...
    public void updateWindowControls() {
        if (win!=null) {
            ViewerWindow iWin = (ViewerWindow)win;
...
//    }
	...
	public synchronized void setCurrentPosition(int[] position) {
		...
		if (win!=null){
			((ViewerWindow)win).updateSliceSelector();
		}
    ...
    public void setDisplayMode(int displayMode) {
        ...
        ViewerWindow win = (ViewerWindow)getWindow();
        if (win!=null) {
	...
	public void updateImage() {
		...
		int displayMode = -1;
		if (win!=null)
			displayMode = ((ViewerWindow)win).getDisplayMode();
    ...
    public void draw(){
        if (win!=null)
            ((ViewerWindow)win).repaintCanvasses();
//            win.getCanvas().repaint();
    ...
    public void updateAndDraw() {
        if (win != null)
            ((ViewerWindow)win).setImagesUpdated(); 
...
//                channelCMBlues[i]=null;
    ...
    public void paste() {
        ...
        if(win!=null) {
            ((ViewerWindow)win).adaptRois(((ViewerCanvas)getCanvas()));
        }
    }
...
//			int baseIndexNew = highIndex*lowerDimSize*newSize+1;
        ...
        if (win != null) {
            ((ViewerWindow)win).updateCanvasses();
        }

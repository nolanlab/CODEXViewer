 ...
 * 
 * Modified according to the needs of CODEXViewer
 */
public class ViewerCanvas extends ImageCanvas {
     ...
     * @param imp
     */
    public ViewerCanvas(ImagePlus imp) {
        super(imp);
    }
...
/** Predicts, whether Canvas can enlarge on this desktop, even in tiled mode */
    ...
    protected Dimension canEnlarge(int newWidth, int newHeight) {
        ...
        Dimension prefSize = ((ViewerLayout)win.getLayout()).
            preferredLayoutSize(win, newWidth, newHeight);
        r1.width = prefSize.width;
        r1.height = prefSize.height;      
        
        Rectangle max = ((ViewerWindow)win).getMaxWindowI5d();
    ...
    public void mouseDragged(MouseEvent e) {        
        ...
        Roi oldMainRoi = null;
        ViewerWindow win = (ViewerWindow) imp.getWindow();
        if (win != null) {
    ...
    protected void adaptChannelRois(boolean thisChannel) {        
        ...
        if (win != null) {            
            if (thisChannel) {
                ...
                win.adaptRois((ViewerCanvas)win.getCanvas());
            }
        }        
    }   
